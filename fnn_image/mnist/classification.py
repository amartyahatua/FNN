...
from mia_score import calculate_mia, get_mia_ibm
...
def main():
    ...
    dataset2, dataset3 = torch.utils.data.random_split(dataset1, [50000, 10000],
                                                       generator=torch.Generator().manual_seed(42))
    dataset4 = datasets.MNIST('../data', train=False, transform=transform)
